...
func (m *MockStorage) SeedData() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SeedData")
}

// SeedData indicates an expected call of SeedData.
func (mr *MockStorageMockRecorder) SeedData() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SeedData", reflect.TypeOf((*MockStorage)(nil).SeedData))
}
...
func (m *MockStorage) UpdateRecord(model interface{}) (interface{}, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateRecord", model)
	ret0, _ := ret[0].(interface{})
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStorageMockRecorder) UpdateRecord(model interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateRecord", reflect.TypeOf((*MockStorage)(nil).UpdateRecord), model)
}
